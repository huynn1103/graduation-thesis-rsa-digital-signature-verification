...
public class CreateQRCodeActivity extends AppCompatActivity {
    ...
    private EditText privateKeyD;
    private EditText privateKeyN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        privateKeyD = findViewById(R.id.txt_private_key_d);
        privateKeyN = findViewById(R.id.txt_private_key_n);
        imageView = findViewById(R.id.iv_ouput);
        btnCreate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String sText = editText.getText().toString().trim();
                String dText = privateKeyD.getText().toString().trim();
                String nText = privateKeyN.getText().toString().trim();
                SignVerify signVerify = new SignVerify();
                String textQR = signVerify.sign(sText, new BigInteger(dText), new BigInteger(nText)) + "|";
                textQR += sText;
